...
{
    public partial class NonOverlapping : UserControl
    {
        public NonOverlapping()
        {
            InitializeComponent();
            manageNonOverlapping1.Hide();
            fillcomboLecturer();
        ...
        {
            manageNonOverlapping1.Show();
            manageNonOverlapping1.BringToFront();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "Insert into Overlap(OLecturer1,OLecturer2,OSubjectCode,OSubjectName,OGroup,OTag) values ('" + SelectLecturer1 + "' ,'" + SelectLecturer2 + "','" + SelectSubjectCode + "','" + SelectSubject + "','" + SelectGroup + "','" + SelectSelectTag + "')";
            ...
            MessageBox.Show("Aded Non Overlapping Session.", "Added", MessageBoxButtons.OK);
            Clear();
        }
        ...
        private void manageNonOverlapping1_Load(object sender, EventArgs e)
        {
