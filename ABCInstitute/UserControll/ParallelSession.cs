...
{
    public partial class ParallelSession : UserControl
    {
        public ParallelSession()
        {
            InitializeComponent();
            manageParallelSession1.Hide();
            fillcomboLecturer();
        ...
        {
            manageParallelSession1.Show();
            manageParallelSession1.BringToFront();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "Insert into Parallel(PLecturer1,PLecturer2,PSubjectCode,PSubjectName,PGroup,PTag) values ('" + SelectLecturer1 + "' ,'" + SelectLecturer2 + "','" + SelectSubjectCode + "','" + SelectSubject + "','" + SelectGroup + "','" + SelectSelectTag + "')";
        ...
        private void manageParallelSession1_Load(object sender, EventArgs e)
        {
